...
HEX_CODE_RE = re.compile(r"#(?:[a-f0-9]{6}|[a-f0-9]{3})(?![a-z0-9])", re.IGNORECASE)
HEX_CODE_INVALID_MESG = "DeclareThatColor: not a valid hexadecimal color value: {}"
...
def rgb(hex_code):
    ...
    return (hex_decimal >> 16, hex_decimal >> 8 & 0xFF, hex_decimal & 0xFF)
